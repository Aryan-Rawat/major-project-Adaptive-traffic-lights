...
class TrafficUi(QMainWindow):    
    def __init__(self):
        ...
        self.east_road_pixmap = QPixmap('.\YOLOv5_results\east.jpg')
        ...
        self.east_road_bbox_pixmap = QPixmap('.\YOLOv5_results\east_bbox.jpg')
        ...
        self.south_road_pixmap = QPixmap('.\YOLOv5_results\south.jpg')
        ...
        self.south_road_bbox_pixmap = QPixmap('.\YOLOv5_results\south_bbox.jpg')
        ...
        self.west_road_pixmap = QPixmap('.\YOLOv5_results\west.jpg')
        ...
        self.west_road_bbox_pixmap = QPixmap('.\YOLOv5_results\west_bbox.jpg')
        ...
        self.north_road_pixmap = QPixmap('.\YOLOv5_results\north.jpg')
        ...
        self.north_road_bbox_pixmap = QPixmap('.\YOLOv5_results\north_bbox.jpg')
